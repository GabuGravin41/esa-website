...
membership_urlpatterns = [
    # NEW: Manual transaction submission (active)
    path('membership/submit-transaction/', membership_views.submit_manual_transaction, name='submit_manual_transaction'),
    
    # OLD: Automated payment URLs (commented but kept for when payment system goes live)
